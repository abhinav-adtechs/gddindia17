...
package com.google.gdgvit.apps.gdd17.sync.account;
...
public class Account {
    ...
    private static final String TAG = LogUtils.makeLogTag(Account.class);
    ...
    public static android.accounts.Account createSyncAccount(Activity activity) {
        ...
        if (accountManager.addAccountExplicitly(account, null, null)) {
            ...
            LogUtils.LOGE(TAG, "Unable to create account");
            return null;
        }
    }
