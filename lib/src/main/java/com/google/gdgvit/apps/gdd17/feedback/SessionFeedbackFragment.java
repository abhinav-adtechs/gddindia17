...
package com.google.gdgvit.apps.gdd17.feedback;
...
import com.google.gdgvit.apps.gdd17.archframework.PresenterImpl;
...
import com.google.gdgvit.apps.gdd17.ui.widget.CustomRatingBar;
...
public class SessionFeedbackFragment extends Fragment
    ...
    private List<UserActionListener<SessionFeedbackModel.SessionFeedbackUserActionEnum>> listeners = new ArrayList<>();
    ...
    public void displayUserActionResult(SessionFeedbackModel model,
                                        final SessionFeedbackModel.SessionFeedbackUserActionEnum userAction, final boolean success) {
    ...
    @Override
    public void addListener(UserActionListener<SessionFeedbackModel.SessionFeedbackUserActionEnum> listener) {
    ...
    private void initPresenter() {
        ...
        PresenterImpl<SessionFeedbackModel, SessionFeedbackModel.SessionFeedbackQueryEnum, SessionFeedbackModel.SessionFeedbackUserActionEnum>
                presenter = new PresenterImpl<>(model, this, SessionFeedbackModel.SessionFeedbackUserActionEnum.values(),
    ...
    private void submitFeedback() {
        ...
        for (UserActionListener<SessionFeedbackModel.SessionFeedbackUserActionEnum> listener : listeners) {
            listener.onUserAction(SessionFeedbackModel.SessionFeedbackUserActionEnum.SUBMIT, args);
        }
        getActivity().finish();
    }
}
