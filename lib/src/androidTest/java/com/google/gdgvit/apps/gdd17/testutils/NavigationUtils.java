...
package com.google.gdgvit.apps.gdd17.testutils;
...
//    }
     ...
     */
    public static void checkNavigationItemIsSelected(NavigationModel.NavigationItemEnum expected) {
        boolean selectedFound = false;

        for (int i = 0; i < NavigationModel.NavigationItemEnum.values().length; i++) {
            NavigationModel.NavigationItemEnum item = NavigationModel.NavigationItemEnum.values()[i];
            try {
    ...
    private static Matcher<View> getSelectedItem(NavigationModel.NavigationItemEnum item) {
