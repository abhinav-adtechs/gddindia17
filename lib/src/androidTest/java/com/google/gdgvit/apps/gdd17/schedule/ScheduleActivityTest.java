...
import com.google.gdgvit.apps.gdd17.mockdata.StubActivityContext;
import com.google.gdgvit.apps.gdd17.testutils.MatchersHelper;
import com.google.gdgvit.apps.gdd17.testutils.ThrottleContentObserverIdlingResource;
import com.google.gdgvit.apps.gdd17.util.RegistrationUtils;
import com.google.gdgvit.apps.gdd17.util.TimeUtils;
import com.google.samples.apps.iosched.lib.R;
import com.google.gdgvit.apps.gdd17.mockdata.MyScheduleMockItems;
import com.google.gdgvit.apps.gdd17.navigation.NavigationModel;
import com.google.gdgvit.apps.gdd17.settings.SettingsUtils;
import com.google.gdgvit.apps.gdd17.testutils.NavigationUtils;
...
//    }
    ...
    private void showDay(int day) {
        onView(withId(R.id.view_pager)).perform(MatchersHelper.moveViewPagerToPage(day));
    }
}
